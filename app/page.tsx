      ...
      <footer className="bg-gray-900 text-gray-400 py-12 px-4">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-white text-sm lg:text-base font-semibold mb-4">Product</h3>
              <ul className="space-y-2">
                <li>
                  <a href="#" className="hover:text-white text-sm lg:text-base transition-colors">
                    Features
                  </a>
                </li>
                <li>
            ...
            <div>
              <h3 className="text-white font-semibold text-sm lg:text-base mb-4">Company</h3>
              <ul className="space-y-2">
                <li>
                  <a href="#" className="hover:text-white text-sm lg:text-base transition-colors">
                    About
            ...
            <div>
              <h3 className="text-white font-semibold text-sm lg:text-base mb-4">Resources</h3>
              <ul className="space-y-2">
                <li>
                  <a href="#" className="hover:text-white text-sm lg:text-base transition-colors">
                    Documentation
            ...
            <div>
              <h3 className="text-white font-semibold text-sm lg:text-base mb-4">Legal</h3>
              <ul className="space-y-2">
                <li>
                  <a href="#" className="hover:text-white text-sm lg:text-base transition-colors">
                    Privacy
